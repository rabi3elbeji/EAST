...
tf.app.flags.DEFINE_string('meta', './east_resnet_v1_50_rbox/model.ckpt-9498.meta','')
...
def freeze():
    ...
    f_score, f_geometry = freeze_model.model(input_images, is_training=False)
    ...
    with tf.Session(config = config) as sess:
        ...
        with open(FLAGS.output_dir+'receipt_model.pb', 'wb') as f:
